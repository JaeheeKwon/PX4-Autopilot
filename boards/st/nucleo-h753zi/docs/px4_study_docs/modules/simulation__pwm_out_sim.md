# PX4 Module Architecture: `simulation/pwm_out_sim`

- Source: `src/modules/simulation/pwm_out_sim`
...
flowchart LR
  Module["simulation/pwm_out_sim"]:::module
  Build["px4 module: modules__simulation__pwm_ou..."]:::data
...
| Field | Value |
| --- | --- |
| Module path | src/modules/simulation/pwm_out_sim |
| Build kind | px4 module |
| Build target | modules__simulation__pwm_out_sim |
| Runtime main | pwm_out_sim |
...
flowchart LR
  ...
  Logic["pwm_out_sim logic"]:::module
...
| --- | --- |
| actuator_outputs_sim | published |
...
%%{init: {"theme":"base","themeVariables":{"primaryColor":"#f1f3f5","secondaryColor":"#e9ecef","tertiaryColor":"#f8f9fa","primaryBorderColor":"#6c757d","primaryTextColor":"#212529","lineColor":"#6c757d","fontFamily":"Inter, Arial, sans-serif"}}}%%
flowchart TD
  Start["px4 pwm_out_sim start"]:::exec
...
stateDiagram-v2
  ...
  S0: PWM_SIM_DISARMED_MAGIC
  Initialized --> S0: detected state path
  S1: PWM_SIM_FAILSAFE_MAGIC
...
sequenceDiagram
  ...
  participant M as pwm_out_sim
  participant P as Parameters
  participant U as uORB
  participant W as Scheduler
  CLI->>M: start pwm_out_sim
...
| PWMSim.cpp | source |
| PWMSim.hpp | header |
| module_hil.yaml | config |
| module_sim.yaml | config |
