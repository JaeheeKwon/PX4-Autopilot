# PX4 Module Architecture: `muorb/apps`

- Source: `src/modules/muorb/apps`
- Build target: `modules__muorb__apps`
- Runtime main: `muorb`
...
Provides the application-side multi-uORB bridge target.
...
- Implement the main behavior in classes such as `AppsProtobufChannel`, `uORB`.
...
| Key classes | `AppsProtobufChannel`, `uORB` |
...
| uORBAppsProtobufChannel.cpp | Entry point, start command, or module lifecycle code |
| CMakeLists.txt | Build, parameter, or module configuration |
| uORBAppsProtobufChannel.hpp | Defines `AppsProtobufChannel` class |
...
flowchart LR
  Module["muorb/apps"]:::module
  Build["px4 module: modules__muorb__apps"]:::data
...
| Field | Value |
| --- | --- |
| Module path | src/modules/muorb/apps |
| Build kind | px4 module |
| Build target | modules__muorb__apps |
| Runtime main | muorb |
...
classDiagram
  ...
  AppsProtobufChannel : uORBAppsProtobufChannel.hpp
  class uORB
  uORB : uORBAppsProtobufChannel.hpp
```
...
| uORBAppsProtobufChannel.cpp | source |
| uORBAppsProtobufChannel.hpp | header |
