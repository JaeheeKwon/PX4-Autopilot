# PX4 Module Architecture: `hardfault_stream`

- Source: `src/modules/hardfault_stream`
- Build target: `modules__hardfault_stream`
- Runtime main: `hardfault_stream`
...
flowchart LR
  Module["hardfault_stream"]:::module
  Build["px4 module: modules__hardfault_stream"]:::data
  Params["parameters / module.yaml"]:::data
  Schedule["task, work queue, or callback"]:::exec
  subgraph Inputs
    In0["mavlink_log"]:::io
    In1["telemetry_status"]:::io
  end
...
| Field | Value |
| --- | --- |
| Module path | src/modules/hardfault_stream |
| Build kind | px4 module |
| Build target | modules__hardfault_stream |
| Runtime main | hardfault_stream |
...
flowchart LR
  ...
  Logic["hardfault_stream logic"]:::module
...
%%{init: {"theme":"base","themeVariables":{"primaryColor":"#f1f3f5","secondaryColor":"#e9ecef","tertiaryColor":"#f8f9fa","primaryBorderColor":"#6c757d","primaryTextColor":"#212529","lineColor":"#6c757d","fontFamily":"Inter, Arial, sans-serif"}}}%%
flowchart TD
  Start["px4 hardfault_stream start"]:::exec
...
sequenceDiagram
  ...
  participant M as hardfault_stream
  participant P as Parameters
  participant U as uORB
  participant W as Scheduler
  CLI->>M: start hardfault_stream
...
%%{init: {"theme":"base","themeVariables":{"primaryColor":"#f1f3f5","secondaryColor":"#e9ecef","tertiaryColor":"#f8f9fa","primaryBorderColor":"#6c757d","primaryTextColor":"#212529","lineColor":"#6c757d","fontFamily":"Inter, Arial, sans-serif"}}}%%
classDiagram
  class HardfaultStream
  HardfaultStream : HardfaultStream.hpp
  class ModuleBase
  ModuleBase <|-- HardfaultStream
  class State
  State : HardfaultStream.hpp
```
...
| Class | Base | File |
| --- | --- | --- |
| HardfaultStream | ModuleBase | HardfaultStream.hpp |
| State |  | HardfaultStream.hpp |
...
| HardfaultStream.cpp | source |
| HardfaultStream.hpp | header |
| params.yaml | config |
