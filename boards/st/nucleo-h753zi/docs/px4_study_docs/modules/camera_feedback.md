# PX4 Module Architecture: `camera_feedback`

- Source: `src/modules/camera_feedback`
- Build target: `modules__camera_feedback`
- Runtime main: `camera_feedback`
...
flowchart LR
  Module["camera_feedback"]:::module
  Build["px4 module: modules__camera_feedback"]:::data
  Params["parameters / module.yaml"]:::data
  Schedule["task, work queue, or callback"]:::exec
  subgraph Inputs
    In0["camera_trigger"]:::io
    In1["gimbal_device_attitude_status"]:::io
    In2["vehicle_attitude"]:::io
    In3["vehicle_global_position"]:::io
  end
  subgraph Outputs
    Out0["camera_capture"]:::io
  end
  In0 --> Module
  In1 --> Module
  In2 --> Module
...
| Field | Value |
| --- | --- |
| Module path | src/modules/camera_feedback |
| Build kind | px4 module |
| Build target | modules__camera_feedback |
| Runtime main | camera_feedback |
...
flowchart LR
  ...
  Logic["camera_feedback logic"]:::module
  ...
  Logic --> UORBOut
  Logic --> Status
  Sub0["camera_trigger"]:::io --> UORBIn
  Sub1["gimbal_device_attitude_status"]:::io --> UORBIn
  Sub2["vehicle_attitude"]:::io --> UORBIn
  Sub3["vehicle_global_position"]:::io --> UORBIn
  UORBOut --> Pub0["camera_capture"]:::io
classDef module fill:#f1f3f5,stroke:#343a40,color:#212529;
classDef io fill:#e9ecef,stroke:#6c757d,color:#212529;
classDef data fill:#f8f9fa,stroke:#6c757d,color:#212529;
classDef exec fill:#dee2e6,stroke:#343a40,color:#212529;
...
%%{init: {"theme":"base","themeVariables":{"primaryColor":"#f1f3f5","secondaryColor":"#e9ecef","tertiaryColor":"#f8f9fa","primaryBorderColor":"#6c757d","primaryTextColor":"#212529","lineColor":"#6c757d","fontFamily":"Inter, Arial, sans-serif"}}}%%
flowchart TD
  Start["px4 camera_feedback start"]:::exec
...
sequenceDiagram
  ...
  participant M as camera_feedback
  participant P as Parameters
  participant U as uORB
  participant W as Scheduler
  CLI->>M: start camera_feedback
...
classDiagram
  ...
  CameraFeedback : CameraFeedback.hpp
  class ModuleBase
  ModuleBase <|-- CameraFeedback
```
...
| Class | Base | File |
| --- | --- | --- |
| CameraFeedback | ModuleBase | CameraFeedback.hpp |
...
| CameraFeedback.cpp | source |
| CameraFeedback.hpp | header |
