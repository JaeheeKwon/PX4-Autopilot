# PX4 Module Architecture: `simulation/sensor_airspeed_sim`

- Source: `src/modules/simulation/sensor_airspeed_sim`
- Build target: `modules__simulation__sensor_airspeed_sim`
- Runtime main: `sensor_airspeed_sim`
...
flowchart LR
  Module["simulation/sensor_airspeed_sim"]:::module
  Build["px4 module: modules__simulation__sensor..."]:::data
  Params["parameters / module.yaml"]:::data
  Schedule["task, work queue, or callback"]:::exec
  subgraph Inputs
    In0["parameter_update"]:::io
    In1["vehicle_attitude"]:::io
    In2["vehicle_command"]:::io
    In3["vehicle_global_position_groundtruth"]:::io
    In4["vehicle_local_position_groundtruth"]:::io
  end
  subgraph Outputs
...
| Field | Value |
| --- | --- |
| Module path | src/modules/simulation/sensor_airspeed_sim |
| Build kind | px4 module |
| Build target | modules__simulation__sensor_airspeed_sim |
| Runtime main | sensor_airspeed_sim |
...
flowchart LR
  ...
  Logic["sensor_airspeed_sim logic"]:::module
  ...
  Sub1["vehicle_attitude"]:::io --> UORBIn
  Sub2["vehicle_command"]:::io --> UORBIn
  Sub3["vehicle_global_position_groundtruth"]:::io --> UORBIn
  Sub4["vehicle_local_position_groundtruth"]:::io --> UORBIn
...
%%{init: {"theme":"base","themeVariables":{"primaryColor":"#eef0f2","secondaryColor":"#e1e5e8","tertiaryColor":"#fafafa","primaryBorderColor":"#59636e","primaryTextColor":"#202428","lineColor":"#59636e","fontFamily":"Inter, Arial, sans-serif"}}}%%
flowchart TD
  Start["px4 sensor_airspeed_sim start"]:::exec
...
sequenceDiagram
  ...
  participant M as sensor_airspeed_sim
  participant P as Parameters
  participant U as uORB
  participant W as Scheduler
  CLI->>M: start sensor_airspeed_sim
...
%%{init: {"theme":"base","themeVariables":{"primaryColor":"#eef0f2","secondaryColor":"#e1e5e8","tertiaryColor":"#fafafa","primaryBorderColor":"#59636e","primaryTextColor":"#202428","lineColor":"#59636e","fontFamily":"Inter, Arial, sans-serif"}}}%%
classDiagram
  class SensorAirspeedSim
  SensorAirspeedSim : SensorAirspeedSim.hpp
  class ModuleBase
  ModuleBase <|-- SensorAirspeedSim
```
...
| Class | Base | File |
| --- | --- | --- |
| SensorAirspeedSim | ModuleBase | SensorAirspeedSim.hpp |
...
| SensorAirspeedSim.cpp | source |
| SensorAirspeedSim.hpp | header |
