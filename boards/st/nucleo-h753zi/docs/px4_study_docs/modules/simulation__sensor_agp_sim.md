# PX4 Module Architecture: `simulation/sensor_agp_sim`

- Source: `src/modules/simulation/sensor_agp_sim`
- Build target: `modules__simulation__sensor_agp_sim`
- Runtime main: `sensor_agp_sim`
...
flowchart LR
  Module["simulation/sensor_agp_sim"]:::module
...
| Field | Value |
| --- | --- |
| Module path | src/modules/simulation/sensor_agp_sim |
| Build kind | px4 module |
| Build target | modules__simulation__sensor_agp_sim |
| Runtime main | sensor_agp_sim |
...
flowchart LR
  ...
  Logic["sensor_agp_sim logic"]:::module
  ...
  UORBOut --> Pub0["aux_global_position"]:::io
classDef module fill:#edf2f4,stroke:#2f3437,color:#1f2326;
classDef io fill:#d9dee2,stroke:#5c636a,color:#1f2326;
classDef data fill:#f7f9fa,stroke:#5c636a,color:#1f2326;
classDef exec fill:#cfd4d8,stroke:#2f3437,color:#1f2326;
...
%%{init: {"theme":"base","themeVariables":{"primaryColor":"#edf2f4","secondaryColor":"#d9dee2","tertiaryColor":"#f7f9fa","primaryBorderColor":"#5c636a","primaryTextColor":"#1f2326","lineColor":"#5c636a","fontFamily":"Inter, Arial, sans-serif"}}}%%
flowchart TD
  Start["px4 sensor_agp_sim start"]:::exec
...
sequenceDiagram
  ...
  participant M as sensor_agp_sim
  participant P as Parameters
  participant U as uORB
  participant W as Scheduler
  CLI->>M: start sensor_agp_sim
...
classDiagram
  class SensorAgpSim
  SensorAgpSim : SensorAgpSim.hpp
  class ModuleBase
  ModuleBase <|-- SensorAgpSim
  class FailureMode
  FailureMode : SensorAgpSim.hpp
```
...
| Class | Base | File |
| --- | --- | --- |
| SensorAgpSim | ModuleBase | SensorAgpSim.hpp |
| FailureMode |  | SensorAgpSim.hpp |
...
| SensorAgpSim.cpp | source |
| SensorAgpSim.hpp | header |
